    ...
    public partial class AddLogEntry : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, new DateTime(2025, 10, 4, 20, 8, 53, 389, DateTimeKind.Local).AddTicks(6780), "Commander", "1LT", 1 });

            migrationBuilder.InsertData(
                table: "AstronautDuty",
                columns: new[] { "Id", "DutyEndDate", "DutyStartDate", "DutyTitle", "PersonId", "Rank" },
                values: new object[] { 1, null, new DateTime(2025, 10, 4, 20, 8, 53, 389, DateTimeKind.Local).AddTicks(6835), "Commander", 1, "1LT" });
        }
